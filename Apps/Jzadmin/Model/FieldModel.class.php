...
class FieldModel extends CommonModel {
	...
	public function defaultField() {
		//字段表
		$field = array ('catid' => array ('name' => "栏目", "type" => 'catid', "default_value" => "smallint(5) unsigned NOT NULL DEFAULT '0'", "required" => 1 ), 'title' => array ('name' => "标题", "type" => 'title', "default_value" => "varchar(255) NOT NULL DEFAULT ''", "required" => 1 ), 'thumb' => array ('name' => "缩略图", "type" => 'image', "default_value" => "varchar(255) NOT NULL DEFAULT ''" ), 'keyword' => array ('name' => "关键词", "type" => 'text', "default_value" => "varchar(120) NOT NULL DEFAULT ''" ), 'description' => array ('name' => "描述", "type" => 'textarea', "default_value" => "varchar(255) NOT NULL DEFAULT ''" ), 'content' => array ('name' => "内容", "type" => 'editor', "default_value" => "longtext NOT NULL" ), 'posid' => array ('name' => "推荐位", "type" => 'posid', "default_value" => "varchar(10)  NOT NULL DEFAULT ''" ), 'status' => array ('name' => "状态", "type" => 'radio', "default_value" => "tinyint(1) unsigned NOT NULL DEFAULT '0'", "setup" => "a:5:{s:7:&quot;options&quot;;s:12:&quot;是|0
